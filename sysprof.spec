...
Source0  : https://download.gnome.org/sources/sysprof/48/sysprof-48.0.tar.xz
...
Requires: sysprof-staticdev = %{version}-%{release}
...
%prep
%setup -q -n sysprof-48.0
cd %{_builddir}/sysprof-48.0
pushd ..
cp -a sysprof-48.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742912925
...
%files libexec
%defattr(-,root,root,-)
/V3/usr/libexec/sysprof-live-unwinder
/V3/usr/libexec/sysprofd
/usr/libexec/sysprof-live-unwinder
