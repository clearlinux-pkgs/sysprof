...
Source0  : https://download.gnome.org/sources/sysprof/3.42/sysprof-3.42.0.tar.xz
...
%prep
%setup -q -n sysprof-3.42.0
cd %{_builddir}/sysprof-3.42.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1632417782
...
cp %{_builddir}/sysprof-3.42.0/COPYING %{buildroot}/usr/share/package-licenses/sysprof/8624bcdae55baeef00cd11d5dfcfa60f68710a02
cp %{_builddir}/sysprof-3.42.0/COPYING.gpl-2 %{buildroot}/usr/share/package-licenses/sysprof/dfac199a7539a404407098a2541b9482279f690d
cp %{_builddir}/sysprof-3.42.0/src/libsysprof-capture/COPYING %{buildroot}/usr/share/package-licenses/sysprof/f0464855038f72585350235098599184ac3b3810
