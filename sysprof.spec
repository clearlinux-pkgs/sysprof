...
Version  : 45.2
Release  : 23
URL      : https://download.gnome.org/sources/sysprof/45/sysprof-45.2.tar.xz
Source0  : https://download.gnome.org/sources/sysprof/45/sysprof-45.2.tar.xz
...
%prep
%setup -q -n sysprof-45.2
cd %{_builddir}/sysprof-45.2
pushd ..
cp -a sysprof-45.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707497705
