...
Source0  : https://download.gnome.org/sources/sysprof/47/sysprof-47.2.tar.xz
...
%prep
%setup -q -n sysprof-47.2
cd %{_builddir}/sysprof-47.2
pushd ..
cp -a sysprof-47.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1732730336
