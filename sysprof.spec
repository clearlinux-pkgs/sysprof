...
%prep
%setup -q -n sysprof-3.36.0
cd %{_builddir}/sysprof-3.36.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1589805190
...
cp %{_builddir}/sysprof-3.36.0/COPYING %{buildroot}/usr/share/package-licenses/sysprof/8624bcdae55baeef00cd11d5dfcfa60f68710a02
cp %{_builddir}/sysprof-3.36.0/COPYING.gpl-2 %{buildroot}/usr/share/package-licenses/sysprof/dfac199a7539a404407098a2541b9482279f690d
cp %{_builddir}/sysprof-3.36.0/src/libsysprof-capture/COPYING %{buildroot}/usr/share/package-licenses/sysprof/f0464855038f72585350235098599184ac3b3810
...
/usr/include/sysprof-3/sysprof-collector.h
/usr/include/sysprof-3/sysprof-control-source.h
...
/usr/include/sysprof-3/sysprof-memprof-profile.h
/usr/include/sysprof-3/sysprof-memprof-source.h
...
/usr/lib64/libsysprof-memory-3.so
