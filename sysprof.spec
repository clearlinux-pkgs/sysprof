...
Version  : 46.0
Release  : 24
URL      : https://download.gnome.org/sources/sysprof/46/sysprof-46.0.tar.xz
Source0  : https://download.gnome.org/sources/sysprof/46/sysprof-46.0.tar.xz
...
%prep
%setup -q -n sysprof-46.0
cd %{_builddir}/sysprof-46.0
pushd ..
cp -a sysprof-46.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710898406
